 ...
 * ------------------------
 * 2009/08/06 : mx51_erdos_gpio_spi_chipselect_all_inactive () add.
 *              called stop_dvfs() at reboot.
 *
 */
...
void arch_reset(char mode)
{
	...
	/*
	 * SPI de-select
	 * stop DVFS (core Volt/Freq initial)
	 */
	extern void mx51_erdos_gpio_spi_chipselect_all_inactive (void);
	extern void stop_dvfs(void);
	mx51_erdos_gpio_spi_chipselect_all_inactive ();
	stop_dvfs ();
	}
