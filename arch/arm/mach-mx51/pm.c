 ...
 * ------------------------
 * 2009/07/21 : tzic_enable_wake() change.
 * 2009/08/07 : is_near_wakeup() add.
 * 2009/08/21 : ifdef fixed.
 *
 */
...
static int __init pm_init(void)
{
	...
	/* Need to remap the area here since we want the memory region to be executable. */
	suspend_iram_base = __arm_ioremap(SUSPEND_IRAM_BASE_ADDR, SZ_4K, MT_HIGH_VECTORS);
